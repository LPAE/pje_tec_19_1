...
>
> ## 1.7 - Prazo Previsto:
> O prazo de entrega comeca a contar a partir da data de aprovação do desenvolvimento do projeto, de comum acordo entre contatante e contratado. Tendo ele o prazo de previsto de até 6 meses.
>
> ## 1.8 - Restrições:
>
...
> - Varredura
>
> - Faixa de Freqüência: 0,02Hz a 2MHz.
> - Freqüencímetro com Modo Externo e Interno.
> - Ambiente de Operação: 0°C a 40°C, RH < 85% (sem condensação).
> - Ambiente de Armazenamento: -20°C a 70°C, RH < 85%.
> - Uso Interno.
> - Altitude: 2000m.
...
> - Faixa de Freqüência: 0,02Hz ~ 2MHz (7 faixas)
...
> - Entrada: VCF (Freqüência Controlada por Tensão)
> - Impedância de Entrada: 1 kOhms ± 10%
> - Tensão de Entrada: 0V ~ 10V
> - Varredura de Freqüência: 1:1 ~ 100:1
>
> ## 3.5 - Onda Senoidal:
...
>
>1. Display LED: Mostra a freqüência interna ou externa.
>2. Chave POWER: Liga e desliga o equipamento. 
>3. Chave INT / EXT: Pressionado: Mostra a freqüência externa.
>Sem Pressionar: Mostra a freqüência interna.
>4. Chaves FREQUENCY RANGE: Seletores das faixas de freqüência.
...
>9. Conector BNC de Entrada VCF: A entrada VCF (freqüência controlada por tensão) permite varredura externa. O controle RATE de varredura interna deve estar na posição desabilitado (pressionado) quando aplicar tensão externa a este conector BNC.
>10. Conector BNC de Entrada EXT COUNT IN: Usado no modo de
>freqüencímetro externo.
>11. Controles:
> - Dial de Freqüência: Controla a freqüência de saída na faixa selecionada.
> - Controle RATE da Varredura: Chave habilita (puxado) / desabilita (pressionado) o gerador de varredura interna e ajusta a freqüência de varredura.
